...
int main()
{
    ...
    int k=3, n, m;
    cout<<"Enter the values for n and m respectively: ";
    cin>>n>>m;
    kSAT kSATi(k, n, m);
    kSATi.createFormula();
    ...
    hillClimbing(kSATi);
    cout<<"\nUsing Beam Search Algorithm (Beam width = 3):\n";
    beamSearch(kSATi, 3);
    cout<<"\nUsing Beam Search Algorithm (Beam width = 4):\n";
    beamSearch(kSATi, 4);
    cout<<"\nUsing Variable Neighborhood Descent Algorithm:\n";
